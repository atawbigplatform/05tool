...
import alinkFile = require("./ALink");
...
export module XScroll {
    ...
    export class XScrollReact extends domCore.DomReact<XScrollProps, XScrollStates, XScrollAction> implements domCore.IReact {
        ...
        private fun_mouseDown(e: React.FormEvent<string>)
        {
        ...
        private fun_touch_begin(e: React.TouchEvent<string>) {
            this.props.Vm.IsMove = true;
            this.props.Vm.X0 = e.touches[0].screenX;
            this.props.Vm.IsFirstMove = true;
        }
        private fun_touch_end(e: React.TouchEvent<string>) {
            this.props.Vm.IsMove = false;
            this.props.Vm.X0 = 0;
        }
        private fun_touch_move(e: React.TouchEvent<string>) {
        ...
        private fun_mouseMove(e: React.FormEvent<any>) {
            this.move(e["clientX"]);
        }
        ...
        public pSender(): React.ReactElement<any> {            
            return <div className="Hf-menu">
                ...
                <div className="ACT-MENU-ICON pull-left Hu-icon Hu-pointer"><i className={" fa fa-angle-right" + (this.props.Vm.IsHidden ? " Ha-transform" :" ")} onClick={() => { this.showFun() } }></i></div>
                <div className={"Hf-menu-all " + (this.props.Vm.IsHidden?"":" hide")}>{this.props.Vm.FunSetInnerContent()}</div>
            </div>;
        }
