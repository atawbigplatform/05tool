    ...
    export class BreadItemDomReact extends domCore.DomReact<BreadItemDomProps, BreadItemDomStates, BreadItemDomAction> implements domCore.IReact {
        ...
        public pSender(): React.ReactElement<any> {
            return <li key={this.props.Vm.key} className={((this.props.Vm.LinkList && this.props.Vm.LinkList.length > 0) ? "" : "active") }>
                ...
                <a className={"Hu-icon " + ((this.props.Vm.LinkList && this.props.Vm.LinkList.length > 0) ? "" : "hide")} onClick={(e) => { this._clickEapandFun(); e.stopPropagation(); }}>
                    <i className={"ACT-BREAD-ICON " + (this.props.Vm.IsExpand ? " Ha-transform  " : " ") + ("icon-caret-right fa fa-caret-right ") }></i></a>
                      {this._senderUL()}
                   </li>;
        }
